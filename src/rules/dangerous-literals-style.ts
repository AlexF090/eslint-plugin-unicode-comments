...
const rule: Rule.RuleModule = {
  meta: {
    ...
    docs: {
      description:
        'Disallow typographic Unicode artifacts in string literals that are common tells of unedited AI-generated text',
      recommended: true,
    },
    fixable: undefined,
    schema: [],
    messages: {
      dangerousUnicodeLiteralStyle:
        'String literal contains typographic Unicode artifacts. Use ASCII only.',
      unicodeHyphens:
